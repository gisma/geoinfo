...
\def\cover{{\sffamily\setcounter{page}{0}
        \thispagestyle{empty}
       \placefig{2}{1.5}{width=5cm}{umr_logo_sw_trans}
        \placefig{16.9}{1.5}{width=2.cm}{logo}
        \begin{textblock}{4}(16.6,3.4)\begin{tiny} Spatial Modeling and Analysis\end{tiny}\end{textblock}
        \vspace*{2cm}
        \begin{center}\Large
         Philipps-University of Marburg, Faculty of Geography\\[.5cm]
        \footnotesize http://uni-marburg.de/geography
...
\addresses{\textbf{Christoph Reudenbach}\newline
Philipps University of Marburg
\newline{Email: \href{mailto:reudenbach@uni-marburg.de}{\nolinkurl{reudenbach@uni-marburg.de}}}\newline Corresponding author\\[1cm]
}

\date{\sf\Date~\Month~\Year}
\makeatletter
 \lfoot{\sf Reudenbach: \@date}
\makeatother
...
\begin{figure}
\centering
\includegraphics{Untitled21_files/figure-latex/histogram-1.pdf}
